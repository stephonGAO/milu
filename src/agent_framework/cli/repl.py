...
from agent_framework.cli.config import Settings
from agent_framework.cli.render import BANNER, DIVIDER, c, render_turn
...
def print_header(agent, settings: Settings) -> None:
    """打印欢迎横幅与可用能力概览。"""
    print(f"\n{BANNER}")
    print(c("bold", c("cyan", "  agent-framework — 交互式对话")))
    print(BANNER)
